...
def ent():
    ...
    print(Fore.LIGHTMAGENTA_EX + (pf.figlet_format("ENTERTAINMENT")))
...
def health():
    ...
    print(Fore.LIGHTRED_EX + (pf.figlet_format("HEALTH  NEWS")))

    # Send a request to the BBC news website and get the response
    response = requests.get('https://www.bbc.com/news/health')
